...
import static io.wisoft.iotplatform.device.fixture.Fixtures.registerDeviceDto;
import static io.wisoft.iotplatform.device.service.dto.DeviceDto.*;
...
//        .withBody("14")));
  ...
  public void registerDuplicatedName() throws Exception {
    ...
    final DeviceRegister newRegisterDeviceDto = registerDeviceDto();
